...
ggplot(ief.spi, aes(gdp, spi)) + geom_point(aes(color=Region)) + geom_smooth() +
...
ggplot(ief.spi, aes(score, spi)) + geom_point(aes(color=Region)) + geom_smooth() +
  labs(x = "2018 Index of economic freedom", y = "2017 Social progress index")
```

## Discussion: 
Spi increases as GDP increases, to a point near GDP=50000, and after that point, spi decreases as GDP increases. 
Spi increases as ief score increases.
